...
// 04/22/2011 dhd CR 18941- Memo files with non-standard block sizes were not maintained properly
...
{$ifdef SUPPORT_INT64}
//  function  LockSection(const Offset: Int64; const Length: Cardinal; const Wait: Boolean): Boolean; override; // 03/04/2011 pb  CR 18372
    function  LockSection(const Offset: Int64; const Length: Cardinal; const Wait, AllPages: Boolean; const PageNo: Integer): Boolean; override; // 05/16/2011 pb  CR 18797
{$else}
//  function  LockSection(const Offset, Length: Cardinal; const Wait: Boolean): Boolean; override;
    function  LockSection(const Offset, Length: Cardinal; const Wait, AllPages: Boolean; const PageNo: Integer): Boolean; override; // 05/16/2011 pb  CR 18797
{$endif}
{$ifdef SUPPORT_INT64}
//  function  UnlockSection(const Offset: Int64; const Length: Cardinal): Boolean; override; // 03/04/2011 pb  CR 18372
    function  UnlockSection(const Offset: Int64; const Length: Cardinal; const AllPages: Boolean; const PageNo: Integer): Boolean; override; // 05/16/2011 pb  CR 18797
{$else}
//  function  UnlockSection(const Offset, Length: Cardinal): Boolean; override;
    function  UnlockSection(const Offset, Length: Cardinal; const AllPages: Boolean; const PageNo: Integer): Boolean; override; // 05/16/2011 pb  CR 18797
{$endif}
...
begin
  ...
  begin
    ...
    HeaderSize := GetBlockLen;   // 04/22/2011 dhd CR 18941
...
{$ifdef SUPPORT_INT64}
//function  TNullMemoFile.LockSection(const Offset: Int64; const Length: Cardinal; const Wait: Boolean): Boolean; // 03/04/2011 pb  CR 18372
function  TNullMemoFile.LockSection(const Offset: Int64; const Length: Cardinal; const Wait, AllPages: Boolean; const PageNo: Integer): Boolean; // 05/16/2011 pb  CR 18797
{$else}
//function  TNullMemoFile.LockSection(const Offset, Length: Cardinal; const Wait: Boolean): Boolean;
function  TNullMemoFile.LockSection(const Offset, Length: Cardinal; const Wait, AllPages: Boolean; const PageNo: Integer): Boolean; // 05/16/2011 pb  CR 18797
{$endif}
begin
  Result := true;
end;
...
{$ifdef SUPPORT_INT64}
//function  TNullMemoFile.UnlockSection(const Offset: Int64; const Length: Cardinal): Boolean; // 03/04/2011 pb  CR 18372
function  TNullMemoFile.UnlockSection(const Offset: Int64; const Length: Cardinal; const AllPages: Boolean; const PageNo: Integer): Boolean; // 05/16/2011 pb  CR 18797
{$else}
//function  TNullMemoFile.UnlockSection(const Offset, Length: Cardinal): Boolean;
function  TNullMemoFile.UnlockSection(const Offset, Length: Cardinal; const AllPages: Boolean; const PageNo: Integer): Boolean; // 05/16/2011 pb  CR 18797
{$endif}
begin
  Result := true;
end;
