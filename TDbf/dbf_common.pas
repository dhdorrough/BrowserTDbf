...
//  TDBF_MINOR_VERSION      = 9;
  TDBF_MAJOR_VERSION      = 7; // 06/16/2011 pb  CR 19142
  TDBF_MINOR_VERSION      = 0; // 06/16/2011 pb  CR 19142
...
{$ifdef SUPPORT_INT64}
  TSequentialRecNo = Int64; // 08/18/2011 pb  CR 19448
  TFileOffset = Int64; // 06/24/2011 pb  CR 19106
{$else}
  TSequentialRecNo = Integer; // 08/18/2011 pb  CR 19448
  TFileOffset = Integer; // 06/24/2011 pb  CR 19106
{$endif}
